...
export const metadata: Metadata = {
  ...
  description: 'Kaş Guide, Kaş\'ta gezilecek yerler, restoranlar, barlar ve yerel öneriler sunan kapsamlı bir şehir rehberidir. Yerel uzmanlar tarafından hazırlandı.',
  keywords: 'kaş gezilecek yerler, kaş restoranlar, kaş oteller, kaş gezi rehberi, kaş türkiye, kaş plajları, kaş aktiviteler',
